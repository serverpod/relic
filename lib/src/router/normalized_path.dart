...
///
/// Instances are interned using an LRU cache for efficiency, meaning
/// identical normalized paths will often share the same object instance.
class NormalizedPath {
  ...
  /// and removing empty segments. The resulting [NormalizedPath] instance
  /// may be retrieved from a cache if an identical normalized path has been
  /// created recently.
  ...
  ///
  /// Returns true if the other object is also a [NormalizedPath] and represents
  /// the exact same sequence of path segments.
  @override
