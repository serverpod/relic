...
///
/// Keeps a fixed number of items ([_maxSize]). When the cache is full and a
/// new item is added, the least recently used item is evicted.
/// Accessing an item (get or update) marks it as the most recently used.
final class LruCache<K, V> {
  ...
  ///
  /// Returns null if the key is not found. Accessing the key marks it as the
  ...
  /// marks it as the most recently used item. If adding the item exceeds the
  /// cache capacity, the least recently used item is evicted.
