...
void main() {
  ...
  final element3 =
      ForwardedElement(forwardedFor: const ForwardedIdentifier('client2'));

  group('Equality and HashCode', () {
    test(
        'Given two identical ForwardedHeader instances, '
        'when compared with ==, '
    ...
    test(
        'Given two ForwardedHeader instances with different element lists, '
        'when compared with ==, '
