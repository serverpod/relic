...
void main() {
  group('Given an Allow header with validation', () {
    ...
    test('when an empty Allow header is passed then the server responds '
    ...
    test('when an Allow header with an invalid value is passed '
    ...
    test('when an Allow header with duplicate methods is passed then it should '
        'parse the methods correctly and remove duplicates', () async {
      final headers = await getServerRequestHeaders(
        server: server,
    ...
    test('when an Allow header with spaces is passed then it should parse the '
        'methods correctly', () async {
      final headers = await getServerRequestHeaders(
        server: server,
        headers: {'allow': ' GET , POST , DELETE '},
        touchHeaders: (final h) => h.allow,
  ...
  group('Given an Allow header without validation', () {
    late RelicServer server;
