...
void main() {
  group('Given a Content-Location header with validation', () {
    ...
    test('when a Content-Location header with an invalid value is passed '
    ...
    test('when a Content-Location header with a valid URI is passed then it '
    ...
    test(
      ...
      () async {
        ...
        expect(headers.contentLocation?.port, equals(8080));
      },
    );
  ...
  group('Given a Content-Location header without validation', () {
    late RelicServer server;
