...
void main() {
  ...
  group('Given malformed Range headers', () {
    test('Given a syntactically invalid Range header, '
    ...
    test('Given a Range header with no "bytes=" prefix, '
        'when a request is made for the file, '
        'then an InvalidHeaderException is thrown', () async {
      final headers = Headers.fromMap({
        'range': ['0-5'],
    ...
    test('Given a completely malformed Range header, '
        'when a request is made for the file, '
        'then an InvalidHeaderException is thrown', () async {
      final headers = Headers.fromMap({
        'range': ['abc123xyz'],
  ...
  group('Given potentially problematic Range requests', () {
    test('Given a Range request with start beyond file length, '
        'when a request is made for the file, '
    ...
    test('Given a suffix-byte-range-spec greater than file length, '
        'when a request is made for the file, '
    ...
    test('Given a Range request where end < start, '
        'when a request is made for the file, '
        'then a 416 Requested Range Not Satisfiable is returned', () async {
      // Invalid range: end (2) < start (5)
      final headers = Headers.build(
        (final mh) => mh.range = RangeHeader(ranges: [Range(start: 5, end: 2)]),
      );
  ...
  group('Given empty Range requests', () {
    test('Given a Range header with no ranges, '
        'when a request is made for the file, '
        'then an InvalidHeaderException is thrown', () async {
