...
<DocFeatureCards
  features={[
    ...
    { icon: '🔌', title: 'WebSockets', description: 'Built-in WebSocket support for real time communication.' },
    ...
    { icon: '🚀', title: 'Production', description: 'Production-ready with high test coverage (3,000+ tests).' },
  ]}
/>
