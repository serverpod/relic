...
GITHUB_CODE_BLOCK lang="dart" [src](https://raw.githubusercontent.com/serverpod/relic/main/example/example.dart) title="hello_world.dart" doctag="hello-world-app"
