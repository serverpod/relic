...
void main() {
  group('Given an Origin header with validation', () {
    ...
    test('when an empty Origin header is passed then the server responds '
    ...
    test('when an Origin header with an invalid URI format is passed '
    ...
    test('when an Origin header with an invalid port number is passed '
        'then the server responds with a bad request including a message that '
        'states the URI format is invalid', () async {
      expect(
        getServerRequestHeaders(
    ...
    test('when an Origin header with an invalid origin format is passed '
    ...
    test(
      ...
      () async {
        ...
        expect(headers.origin, equals(Uri.parse('https://example.com')));
      },
    );
    ...
    test(
      ...
      () async {
        ...
        expect(headers.origin?.port, equals(8080));
      },
    );
