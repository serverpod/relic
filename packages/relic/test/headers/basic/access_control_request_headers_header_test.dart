...
void main() {
  group('Given an Access-Control-Request-Headers header with validation', () {
    ...
    test('when an Access-Control-Request-Headers header with an empty value is '
        'passed then the server does not respond with a bad request if the '
        'headers is not actually used', () async {
    ...
    test('when an Access-Control-Request-Headers header is passed then it '
        'should parse the headers correctly', () async {
      final headers = await getServerRequestHeaders(
        server: server,
        headers: {
  ...
  group(
    'Given an Access-Control-Request-Headers header without validation',
    () {
      late RelicServer server;
      ...
      group(
        'when an empty Access-Control-Request-Headers header is passed',
        () {
