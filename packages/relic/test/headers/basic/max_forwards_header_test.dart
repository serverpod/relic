...
void main() {
  group('Given a Max-Forwards header with validation', () {
    ...
    test('when an empty Max-Forwards header is passed then the server responds '
    ...
    test('when a Max-Forwards header with an invalid value is passed '
    ...
    test('when a Max-Forwards header with a valid integer is passed then it '
  ...
  group('Given a Max-Forwards header without validation', () {
    late RelicServer server;
