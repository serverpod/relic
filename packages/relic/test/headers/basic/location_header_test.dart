...
void main() {
  group('Given a Location header with validation', () {
    ...
    test('when an empty Location header is passed then the server responds '
    ...
    test('when a Location header with an invalid URI is passed then the server '
    ...
    test('when a Location header with an invalid value is passed '
    ...
    test(
      ...
      () async {
        ...
        expect(headers.location, equals(Uri.parse('https://example.com/page')));
      },
    );
    ...
    test(
      ...
      () async {
        ...
        expect(headers.location?.port, equals(8080));
      },
    );
