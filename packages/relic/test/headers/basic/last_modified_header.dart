...
void main() {
  group('Given a Last-Modified header with validation', () {
    ...
    test('when a Last-Modified header with an invalid date format is passed '
    ...
    test('when a valid Last-Modified header is passed then it should parse the '
        'date correctly', () async {
      final headers = await getServerRequestHeaders(
        server: server,
  ...
  group('Given a Last-Modified header without validation', () {
    late RelicServer server;
