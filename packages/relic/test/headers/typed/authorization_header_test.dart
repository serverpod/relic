...
void main() {
  ...
  group('Given authorization header toString() methods', () {
    ...
    test('when BearerAuthorizationHeader.toStringInsecure() is called '
    ...
    test('when BasicAuthorizationHeader.toString() is called '
      ...
      expect(
        result,
        'BasicAuthorizationHeader(username: user, password: ****)',
      );
      expect(result, isNot(contains('secretPassword')));
    });

    test('when BasicAuthorizationHeader.toStringInsecure() is called '
    ...
    test('when DigestAuthorizationHeader.toString() is called '
    ...
    test('when DigestAuthorizationHeader.toStringInsecure() is called '
