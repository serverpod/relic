...
void main() {
  group('Given a Proxy-Authorization header with validation', () {
    ...
    test('when an empty Proxy-Authorization header is passed then the server '
    ...
    test('when a Proxy-Authorization header with an invalid value is passed '
        'then the server does not respond with a bad request if the headers '
        'is not actually used', () async {
      final headers = await getServerRequestHeaders(
        server: server,
        touchHeaders: (_) {},
        headers: {'proxy-authorization': 'invalid-proxy-authorization-format'},
      );
