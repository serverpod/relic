...
void main() {
  group('PathTrie Wildcard (*) Matching', () {
    ...
    test('Given a trie with path /users/*/profile, '
    ...
    test('Given a trie with path /*/resource, '
    ...
    test('Given a trie with path /files/*, '
    ...
    test('Given a trie with path /a/*/c/*, '
    ...
    test('Given a trie with path /a/*/b, '
    ...
    test('Given a trie with path /assets/*, '
    ...
    test('Given a trie with path /api/:version/data/*, '
    ...
    test('Given a trie with path /a/b/*/d, '
    ...
    test('Given a trie with path /a/b/* (no tail), '
